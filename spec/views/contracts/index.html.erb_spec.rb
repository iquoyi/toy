...
RSpec.describe "contracts/index", type: :view do
  before do
    ...
    @contract1.update_attributes(start_date: "2022-03-01", end_date: "2022-03-02", legal: "Legal_1")

    @contract2 = Contract.new(employee_id: @employee.id)
    @contract2.update_attributes(start_date: "2022-03-03", end_date: "2022-03-04", legal: "Legal_2")
